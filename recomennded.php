<?php
session_start();
if (!empty(isset($_POST['shudann']))) {
  $_SESSION['shudann'] = $_POST['shudann'];
}
// var_dump($_POST['shudann']);
var_dump($_SESSION['mokuteki']);
echo "<br />";
var_dump($_SESSION['ikisaki']);
echo "<br />";
var_dump($_POST['shudann']);

if ($_SESSION['mokuteki'] == [1, 2, 3] && $_SESSION['ikisaki'] == [8]){
  echo '<img src="./assets/img/tennmannguu.jpg">';
}
